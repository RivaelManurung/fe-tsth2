      ...
      <div class="col-12 col-md-5 col-lg-4 mb-4">
        <div class="profile-card card text-center">
          <div class="profile-img-container mb-3">
            <img id="currentProfileImg" src="{{ Avatar::create(session('user')['name'])->toBase64() }}" class="profile-img" alt="Profile Picture">
            <label for="uploadFotoProfil" class="edit-icon" data-bs-toggle="modal" data-bs-target="#editProfileModal">
              <i class="bi bi-pencil-fill text-primary fs-6"></i>
            </label>
          </div>
          <h5 class="text-muted  mb-1">{{ session('user')['name'] }}</h5>
          <p class="text-muted small mb-4">{{ session('user')['email'] }}</p>
          <div class="btn-section">
            <a href="{{ route('profile.user_profile') }}" class="btn btn-outline-primary w-100 btn-flat">
              <i class="bi bi-person me-2"></i>Profil Pengguna
            </a>
            <a href="{{ route('profile.ganti-password') }}" class="btn btn-outline-secondary w-100 btn-flat">
...
<form id="uploadFotoForm" method="POST" enctype="multipart/form-data">
  @csrf
  <input type="file" class="d-none" id="uploadFotoProfil" name="foto" accept="image/*">
</form>
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <form id="modalFotoForm" method="POST" enctype="multipart/form-data">
        ...
        <div class="modal-body text-center">
          <div class="mb-3">
            <img id="previewFoto" src="" class="rounded-circle shadow-sm border" style="width: 130px; height: 130px; object-fit: cover;">
          </div>
          <p class="small text-muted">Pastikan foto berformat JPG, PNG atau JPEG.</p>
          <input type="file" class="form-control d-none" id="uploadFotoProfilModal" name="foto" accept="image/*">
   ...
   <div class="navbar navbar-sm navbar-footer border-top">
    <div class="container-fluid">
        <span>&copy; 2025 <a
                href="https://themeforest.net/item/limitless-responsive-web-application-kit/13080328">TSTH2</a></span>
    </div>
</div>
<!-- /footer -->
