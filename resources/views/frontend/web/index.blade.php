            ...
            <div class="col-md-6">
                <div class="card shadow-sm">
                  <div class="card-body text-center">
                      <img src="{{$web['web_logo'] }}" class="mb-3" alt="Logo" style="width: 100px;">            <h6 class="text-muted">Judul Website</h6>
                      <h5>{{ $web['web_nama'] }}</h5>
                      <hr>
                    ...
                    <div class="card-body">
                        ...
                        <form id="upload-form" action="{{ route('webs.update', 1) }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="judul" name="web_nama" value="{{ $web['web_nama'] }}">
                            </div>
                            <div class="mb-3">
